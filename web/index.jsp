...
<head>
    ...
    <title>江南大学学生选课系统</title>
    <script src="js/jquery/2.0.0/jquery.min.js"></script>
    <link href="css/bootstrap/3.3.6/bootstrap.min.css" rel="stylesheet">
    <script src="js/bootstrap/3.3.6/bootstrap.min.js"></script>
    <link rel="icon" href="img/jiangnan.ico" type="image/x-icon">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-group" action="forelogin" method="post">
                            <div class="form-group">
                                <label for="name">用户名</label>
                                <input class="form-control" type="text" placeholder="请输入学号" name="name" id="name">
                            </div>
                            <div class="form-group">
    ...
    <div id="register" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group" action="foreregister" method="post">
                            <div class="form-group">
                                <label for="name">账号</label>
                                <input class="form-control" type="text" placeholder="请输入想注册的学号" name="rname" id="rname">
                            </div>
                            <div class="form-group">
                                <label for="password">密码</label>
                                <input class="form-control" placeholder="请输入想注册的密码" name="rpassword" id="rpassword" type="password">
                            </div>
                            <div class="form-group">
                                <label for="password">用户名</label>
                                <input class="form-control" placeholder="请输入想注册的用户名" name="ruser" id="ruser" type="text">
                            </div>
                            <div class="text-right">
...
<div class="main">
    <div class="header">
        <div class="nav">
            ...
            <div class="entry">
                ...
                <span class="state">Jiangnan University</span>
				
                	<a href="http://www.jiangnan.edu.cn/" target="_blank">访问学校官网</a>
            ...
            <div class="wrap">
                ...
                <div class="mid">
                    <div class="main-entry">
                        <a data-toggle="modal" data-target="#login" href="" class="developer-login"><span class="title"><i
                                class="developer"></i>登陆</span><s></s></a>

                        <a data-toggle="modal" data-target="#register" href="" class="personal-login"><span class="title"><i
                                class="personal"></i>立即注册</span><s></s></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        ...
        <div class="ownership">
            <span> &copy;2017 - <strong>江南大学学生选课系统</strong> - Peter</span>
        </div>
    </div>
</div>
